              ...
              <div className="d-flex align-items-center zn_1 ">
                ...
                >
                  <div class="dropdown ms-xxl-5 ms-2">
                    <button
                      class="bg-transparent text-white border-0 align-items-center d-flex btn-secondary dropdown-toggle ff_gilroy400 fw-normal fs_xsm text_strok"
                      type="button"
                  ...
                  <div className="d-md-flex align-items-center justify-content-center d-md-none">
                    ...
                    <ul className="m-0 p-0">
                      <li>
                        <a
                          href="#"
                          className="d-flex align-items-center justify-content-center ms-0 mt-3 mt-md-0 ml_25 jus"
                        >
